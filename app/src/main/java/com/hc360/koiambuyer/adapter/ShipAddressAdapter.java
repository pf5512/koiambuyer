...
public class ShipAddressAdapter extends BaseQuickAdapter<ShipAddressInfo.ListBean> {
    IShipAddressView mView;
    public ShipAddressAdapter(int layoutResId, List data , IShipAddressView view) {
        super(layoutResId, data);
        this.mView = view;
    }

    @Override
    protected void convert(final BaseViewHolder holder, final ShipAddressInfo.ListBean bean) {
        ...
        btnDefault.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (SPUtils.getBoolean(mContext, Constant._IS_BOSS,false)){
                    ...
                    ToastUtil.showShort(mContext,"对不起，主账户才能改变发货地址状态~");
                }
            }
        });
