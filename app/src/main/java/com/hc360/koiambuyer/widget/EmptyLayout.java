...
import com.hc360.koiambuyer.view.MainActivity;
...
public class EmptyLayout extends FrameLayout {
     ...
     * @param msg 显示消息
     */
    public void setNetErrorMessage(String msg) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_go_home:
                try {
                    this.getContext().startActivity(new Intent(this.getContext(), MainActivity.class));
                }catch (Exception e){
