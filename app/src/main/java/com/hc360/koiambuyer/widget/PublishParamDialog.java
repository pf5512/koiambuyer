...
public class PublishParamDialog extends Dialog {
    ...
    public PublishParamDialog(Context context, int position,int num,int maxNum, @Nullable PurchaseDetailInfo.StProductParasBean info, onSaveListener listener) {
    ...
    private boolean getText() {
        if (listener != null){
            ...
            if (TextUtils.isEmpty(name)||TextUtils.isEmpty(content)){
                ...
                listener.onSave(name,content,mPosition);
                return true;
            }
        }
        return false;
    ...
    public interface onSaveListener{
        void onSave(String name,String content,int position);
    }
