...
//                mTvAddress.setText(proName + " " + cityName + " " + areaName);
                ...
                .setCancelColor(activity.getResources().getColor(MyApp.sLoginType.equals(Constant.BUYER)? R.color.buyerColor:R.color.sellerColor))
                .setSubmitColor(activity.getResources().getColor(MyApp.sLoginType.equals(Constant.BUYER)?R.color.buyerColor:R.color.sellerColor))
